...
async def song(client, message: Message):
    ...
    if not urlissed:
        ...
        return
    pablo = await client.send_message(message.chat.id, f"**◊ جاري التنزيل ◊** `{urlissed}`")
...
async def vsong(client, message: Message):
    ...
    try:
        ...
        await event.edit(event, f"**◊ خطأ في التنزيل ◊** \n**◊ الخطأ ⇾** `{str(e)}`")
        return
    c_time = time.time()
